...
module Pod
  class TemplateConfigurator
    ...
    def replace_variables_in_files
      file_names = ['POD_LICENSE', 'POD_README.md', 'NAME.podspec', '.travis.yml', 'lib/NAME.podspec', 'fmk/NAME.podspec', podfile_path, fastfile_path]
    ...
    def rename_template_files
      ...
      FileUtils.mv "lib/NAME.podspec", "lib/#{pod_name}.podspec"
      FileUtils.mv "fmk/NAME.podspec", "fmk/#{pod_name}.podspec"
    end
